...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder='Tejender')
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder='Tejender Singh')

    teacher_password = st.text_input("Enter password", placeholder='********', type='password')

    teacher_password_confirm = st.text_input("Confirm password", placeholder='********', type='password')
